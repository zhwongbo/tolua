...
public class UnityEngine_AnimatorWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("avatarRoot", new LuaCSFunction(get_avatarRoot), null);
		...
		L.RegVar("keepAnimatorStateOnDisable", new LuaCSFunction(get_keepAnimatorStateOnDisable), new LuaCSFunction(set_keepAnimatorStateOnDisable));
		L.RegVar("writeDefaultValuesOnDisable", new LuaCSFunction(get_writeDefaultValuesOnDisable), new LuaCSFunction(set_writeDefaultValuesOnDisable));
		L.EndClass();
	}
