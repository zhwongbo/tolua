...
public class UnityEngine_TimeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("timeAsDouble", new LuaCSFunction(get_timeAsDouble), null);
		L.RegVar("timeSinceLevelLoad", new LuaCSFunction(get_timeSinceLevelLoad), null);
		L.RegVar("timeSinceLevelLoadAsDouble", new LuaCSFunction(get_timeSinceLevelLoadAsDouble), null);
		L.RegVar("deltaTime", new LuaCSFunction(get_deltaTime), null);
		L.RegVar("fixedTime", new LuaCSFunction(get_fixedTime), null);
		L.RegVar("fixedTimeAsDouble", new LuaCSFunction(get_fixedTimeAsDouble), null);
		L.RegVar("unscaledTime", new LuaCSFunction(get_unscaledTime), null);
		L.RegVar("unscaledTimeAsDouble", new LuaCSFunction(get_unscaledTimeAsDouble), null);
		L.RegVar("fixedUnscaledTime", new LuaCSFunction(get_fixedUnscaledTime), null);
		L.RegVar("fixedUnscaledTimeAsDouble", new LuaCSFunction(get_fixedUnscaledTimeAsDouble), null);
		...
		L.RegVar("realtimeSinceStartupAsDouble", new LuaCSFunction(get_realtimeSinceStartupAsDouble), null);
