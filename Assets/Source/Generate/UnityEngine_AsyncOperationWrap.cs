...
public class UnityEngine_AsyncOperationWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_AsyncOperation));
		...
		L.RegVar("allowSceneActivation", new LuaCSFunction(get_allowSceneActivation), new LuaCSFunction(set_allowSceneActivation));
		L.RegVar("completed", new LuaCSFunction(get_completed), new LuaCSFunction(set_completed));
		L.EndClass();
	}
	...
	static int set_completed(IntPtr L)
	{
		try
		{
			UnityEngine.AsyncOperation obj = (UnityEngine.AsyncOperation)ToLua.CheckObject<UnityEngine.AsyncOperation>(L, 1);
