...
public class UnityEngine_AnimationStateWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("AddMixingTransform", new LuaCSFunction(AddMixingTransform));
		L.RegFunction("RemoveMixingTransform", new LuaCSFunction(RemoveMixingTransform));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_AnimationState));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("enabled", new LuaCSFunction(get_enabled), new LuaCSFunction(set_enabled));
		L.RegVar("weight", new LuaCSFunction(get_weight), new LuaCSFunction(set_weight));
		...
		L.RegVar("normalizedTime", new LuaCSFunction(get_normalizedTime), new LuaCSFunction(set_normalizedTime));
		L.RegVar("speed", new LuaCSFunction(get_speed), new LuaCSFunction(set_speed));
		L.RegVar("normalizedSpeed", new LuaCSFunction(get_normalizedSpeed), new LuaCSFunction(set_normalizedSpeed));
	...
	static int AddMixingTransform(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				UnityEngine.AnimationState obj = (UnityEngine.AnimationState)ToLua.CheckObject<UnityEngine.AnimationState>(L, 1);
