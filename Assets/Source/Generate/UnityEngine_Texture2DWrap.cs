...
public class UnityEngine_Texture2DWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("HasPlaceholder", new LuaCSFunction(HasPlaceholder));
		L.RegFunction("GetOriginalWidth", new LuaCSFunction(GetOriginalWidth));
		L.RegFunction("GetOriginalHeight", new LuaCSFunction(GetOriginalHeight));
		...
		L.RegVar("ignoreMipmapLimit", new LuaCSFunction(get_ignoreMipmapLimit), new LuaCSFunction(set_ignoreMipmapLimit));
		L.RegVar("mipmapLimitGroup", new LuaCSFunction(get_mipmapLimitGroup), null);
		L.RegVar("activeMipmapLimit", new LuaCSFunction(get_activeMipmapLimit), null);
		...
		L.RegVar("vtOnly", new LuaCSFunction(get_vtOnly), null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int HasPlaceholder(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.CheckObject<UnityEngine.Texture2D>(L, 1);
			bool o = obj.HasPlaceholder();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetOriginalWidth(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.CheckObject<UnityEngine.Texture2D>(L, 1);
			int o = obj.GetOriginalWidth();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetOriginalHeight(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Texture2D obj = (UnityEngine.Texture2D)ToLua.CheckObject<UnityEngine.Texture2D>(L, 1);
			int o = obj.GetOriginalHeight();
			LuaDLL.lua_pushinteger(L, o);
			return 1;
		}
		catch (Exception e)
