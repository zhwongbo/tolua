...
public class UnityEngine_TransformWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetLocalPositionAndRotation", new LuaCSFunction(SetLocalPositionAndRotation));
		L.RegFunction("GetPositionAndRotation", new LuaCSFunction(GetPositionAndRotation));
		L.RegFunction("GetLocalPositionAndRotation", new LuaCSFunction(GetLocalPositionAndRotation));
