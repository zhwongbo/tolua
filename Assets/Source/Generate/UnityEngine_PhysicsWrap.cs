...
public class UnityEngine_PhysicsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("invokeCollisionCallbacks", get_invokeCollisionCallbacks, set_invokeCollisionCallbacks);
		...
		L.RegVar("ContactEvent", get_ContactEvent, set_ContactEvent);
	...
	static int BakeMesh(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				int arg0 = (int)LuaDLL.luaL_checknumber(L, 1);
				bool arg1 = LuaDLL.luaL_checkboolean(L, 2);
				UnityEngine.MeshColliderCookingOptions arg2 = (UnityEngine.MeshColliderCookingOptions)ToLua.CheckObject(L, 3, typeof(UnityEngine.MeshColliderCookingOptions));
	...
	static int set_simulationMode(IntPtr L)
	{
		try
		{
			UnityEngine.SimulationMode arg0 = (UnityEngine.SimulationMode)ToLua.CheckObject(L, 2, typeof(UnityEngine.SimulationMode));
