...
public class UnityEngine_PhysicsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("IgnoreCollision", new LuaCSFunction(IgnoreCollision));
		L.RegFunction("IgnoreLayerCollision", new LuaCSFunction(IgnoreLayerCollision));
		L.RegFunction("GetIgnoreLayerCollision", new LuaCSFunction(GetIgnoreLayerCollision));
		L.RegFunction("GetIgnoreCollision", new LuaCSFunction(GetIgnoreCollision));
		L.RegFunction("Raycast", new LuaCSFunction(Raycast));
		L.RegFunction("Linecast", new LuaCSFunction(Linecast));
		L.RegFunction("CapsuleCast", new LuaCSFunction(CapsuleCast));
		L.RegFunction("SphereCast", new LuaCSFunction(SphereCast));
		L.RegFunction("BoxCast", new LuaCSFunction(BoxCast));
		L.RegFunction("RaycastAll", new LuaCSFunction(RaycastAll));
		L.RegFunction("RaycastNonAlloc", new LuaCSFunction(RaycastNonAlloc));
		L.RegFunction("CapsuleCastAll", new LuaCSFunction(CapsuleCastAll));
		L.RegFunction("SphereCastAll", new LuaCSFunction(SphereCastAll));
		L.RegFunction("OverlapCapsule", new LuaCSFunction(OverlapCapsule));
		L.RegFunction("OverlapSphere", new LuaCSFunction(OverlapSphere));
		L.RegFunction("Simulate", new LuaCSFunction(Simulate));
		L.RegFunction("SyncTransforms", new LuaCSFunction(SyncTransforms));
		L.RegFunction("ComputePenetration", new LuaCSFunction(ComputePenetration));
		L.RegFunction("ClosestPoint", new LuaCSFunction(ClosestPoint));
		L.RegFunction("OverlapSphereNonAlloc", new LuaCSFunction(OverlapSphereNonAlloc));
		L.RegFunction("CheckSphere", new LuaCSFunction(CheckSphere));
		L.RegFunction("CapsuleCastNonAlloc", new LuaCSFunction(CapsuleCastNonAlloc));
		L.RegFunction("SphereCastNonAlloc", new LuaCSFunction(SphereCastNonAlloc));
		L.RegFunction("CheckCapsule", new LuaCSFunction(CheckCapsule));
		L.RegFunction("CheckBox", new LuaCSFunction(CheckBox));
		L.RegFunction("OverlapBox", new LuaCSFunction(OverlapBox));
		L.RegFunction("OverlapBoxNonAlloc", new LuaCSFunction(OverlapBoxNonAlloc));
		L.RegFunction("BoxCastNonAlloc", new LuaCSFunction(BoxCastNonAlloc));
		L.RegFunction("BoxCastAll", new LuaCSFunction(BoxCastAll));
		L.RegFunction("OverlapCapsuleNonAlloc", new LuaCSFunction(OverlapCapsuleNonAlloc));
		L.RegFunction("RebuildBroadphaseRegions", new LuaCSFunction(RebuildBroadphaseRegions));
		...
		L.RegVar("gravity", new LuaCSFunction(get_gravity), new LuaCSFunction(set_gravity));
		L.RegVar("defaultContactOffset", new LuaCSFunction(get_defaultContactOffset), new LuaCSFunction(set_defaultContactOffset));
		L.RegVar("sleepThreshold", new LuaCSFunction(get_sleepThreshold), new LuaCSFunction(set_sleepThreshold));
		L.RegVar("queriesHitTriggers", new LuaCSFunction(get_queriesHitTriggers), new LuaCSFunction(set_queriesHitTriggers));
		L.RegVar("queriesHitBackfaces", new LuaCSFunction(get_queriesHitBackfaces), new LuaCSFunction(set_queriesHitBackfaces));
		L.RegVar("bounceThreshold", new LuaCSFunction(get_bounceThreshold), new LuaCSFunction(set_bounceThreshold));
		L.RegVar("defaultMaxDepenetrationVelocity", new LuaCSFunction(get_defaultMaxDepenetrationVelocity), new LuaCSFunction(set_defaultMaxDepenetrationVelocity));
		L.RegVar("defaultSolverIterations", new LuaCSFunction(get_defaultSolverIterations), new LuaCSFunction(set_defaultSolverIterations));
		L.RegVar("defaultSolverVelocityIterations", new LuaCSFunction(get_defaultSolverVelocityIterations), new LuaCSFunction(set_defaultSolverVelocityIterations));
		L.RegVar("simulationMode", new LuaCSFunction(get_simulationMode), new LuaCSFunction(set_simulationMode));
		L.RegVar("defaultMaxAngularSpeed", new LuaCSFunction(get_defaultMaxAngularSpeed), new LuaCSFunction(set_defaultMaxAngularSpeed));
		L.RegVar("improvedPatchFriction", new LuaCSFunction(get_improvedPatchFriction), new LuaCSFunction(set_improvedPatchFriction));
		L.RegVar("invokeCollisionCallbacks", new LuaCSFunction(get_invokeCollisionCallbacks), new LuaCSFunction(set_invokeCollisionCallbacks));
		L.RegVar("defaultPhysicsScene", new LuaCSFunction(get_defaultPhysicsScene), null);
		L.RegVar("autoSyncTransforms", new LuaCSFunction(get_autoSyncTransforms), new LuaCSFunction(set_autoSyncTransforms));
		L.RegVar("reuseCollisionCallbacks", new LuaCSFunction(get_reuseCollisionCallbacks), new LuaCSFunction(set_reuseCollisionCallbacks));
		L.RegVar("interCollisionDistance", new LuaCSFunction(get_interCollisionDistance), new LuaCSFunction(set_interCollisionDistance));
		L.RegVar("interCollisionStiffness", new LuaCSFunction(get_interCollisionStiffness), new LuaCSFunction(set_interCollisionStiffness));
		L.RegVar("interCollisionSettingsToggle", new LuaCSFunction(get_interCollisionSettingsToggle), new LuaCSFunction(set_interCollisionSettingsToggle));
		L.RegVar("clothGravity", new LuaCSFunction(get_clothGravity), new LuaCSFunction(set_clothGravity));
		L.RegVar("ContactModifyEvent", new LuaCSFunction(get_ContactModifyEvent), new LuaCSFunction(set_ContactModifyEvent));
		L.RegVar("ContactModifyEventCCD", new LuaCSFunction(get_ContactModifyEventCCD), new LuaCSFunction(set_ContactModifyEventCCD));
		L.RegVar("ContactEvent", new LuaCSFunction(get_ContactEvent), new LuaCSFunction(set_ContactEvent));
		L.RegFunction("ContactEventDelegate", new LuaCSFunction(UnityEngine_Physics_ContactEventDelegate));
		L.EndStaticLibs();
	}
	...
	static int Raycast(IntPtr L)
	{
		try
		{
			...
			else if (count == 6)
			{
				...
				UnityEngine.QueryTriggerInteraction arg5 = (UnityEngine.QueryTriggerInteraction)ToLua.CheckObject(L, 6, TypeTraits<UnityEngine.QueryTriggerInteraction>.type);
	...
	static int Linecast(IntPtr L)
	{
		try
		{
			...
			else if (count == 5)
			{
				...
				UnityEngine.QueryTriggerInteraction arg4 = (UnityEngine.QueryTriggerInteraction)ToLua.CheckObject(L, 5, TypeTraits<UnityEngine.QueryTriggerInteraction>.type);
	...
	static int CapsuleCast(IntPtr L)
	{
		try
		{
			...
			else if (count == 7 && TypeChecker.CheckTypes<LuaInterface.LuaOut<UnityEngine.RaycastHit>, float, int>(L, 5))
			{
				...
				UnityEngine.RaycastHit arg4;
				float arg5 = (float)LuaDLL.lua_tonumber(L, 6);
				int arg6 = (int)LuaDLL.lua_tointeger(L, 7);
			...
			else if (count == 8)
			{
				...
				int arg6 = (int)LuaDLL.luaL_checkinteger(L, 7);
				UnityEngine.QueryTriggerInteraction arg7 = (UnityEngine.QueryTriggerInteraction)ToLua.CheckObject(L, 8, TypeTraits<UnityEngine.QueryTriggerInteraction>.type);
	...
	static int SphereCast(IntPtr L)
	{
		try
		{
			...
			else if (count == 7)
			{
				...
				UnityEngine.QueryTriggerInteraction arg6 = (UnityEngine.QueryTriggerInteraction)ToLua.CheckObject(L, 7, TypeTraits<UnityEngine.QueryTriggerInteraction>.type);
	...
	static int OverlapSphere(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 2);
				int arg2 = (int)LuaDLL.luaL_checkinteger(L, 3);
				UnityEngine.QueryTriggerInteraction arg3 = (UnityEngine.QueryTriggerInteraction)ToLua.CheckObject(L, 4, TypeTraits<UnityEngine.QueryTriggerInteraction>.type);
	...
	static int BakeMesh(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				int arg0 = (int)LuaDLL.luaL_checkinteger(L, 1);
				bool arg1 = LuaDLL.luaL_checkboolean(L, 2);
				UnityEngine.MeshColliderCookingOptions arg2 = (UnityEngine.MeshColliderCookingOptions)ToLua.CheckObject(L, 3, TypeTraits<UnityEngine.MeshColliderCookingOptions>.type);
				UnityEngine.Physics.BakeMesh(arg0, arg1, arg2);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Physics.BakeMesh");
			}
		}
		catch (Exception e)
		{
	...
	static int get_simulationMode(IntPtr L)
	{
		try
		{
			ToLua.Push(L, UnityEngine.Physics.simulationMode);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_invokeCollisionCallbacks(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, UnityEngine.Physics.invokeCollisionCallbacks);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_ContactEvent(IntPtr L)
	{
		ToLua.Push(L, new EventObject(typeof(UnityEngine.Physics.ContactEventDelegate)));
		return 1;
	}
	...
	static int set_simulationMode(IntPtr L)
	{
		try
		{
			UnityEngine.SimulationMode arg0 = (UnityEngine.SimulationMode)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.SimulationMode>.type);
			UnityEngine.Physics.simulationMode = arg0;
			UnityEngine.Physics.simulationMode = arg0;
			return 0;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_invokeCollisionCallbacks(IntPtr L)
	{
		try
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			UnityEngine.Physics.invokeCollisionCallbacks = arg0;
			UnityEngine.Physics.invokeCollisionCallbacks = arg0;
			return 0;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_ContactEvent(IntPtr L)
	{
		try
		{
			EventObject arg0 = null;
			...
			{
				return LuaDLL.luaL_throw(L, "The event 'UnityEngine.Physics.ContactEvent' can only appear on the left hand side of += or -= when used outside of the type 'UnityEngine.Physics'");
			}

			if (arg0.op == EventOp.Add)
			{
				UnityEngine.Physics.ContactEventDelegate ev = (UnityEngine.Physics.ContactEventDelegate)arg0.func;
				UnityEngine.Physics.ContactEvent += ev;
			}
			else if (arg0.op == EventOp.Sub)
			{
				UnityEngine.Physics.ContactEventDelegate ev = (UnityEngine.Physics.ContactEventDelegate)arg0.func;
