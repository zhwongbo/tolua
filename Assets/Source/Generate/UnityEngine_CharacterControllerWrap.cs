...
public class UnityEngine_CharacterControllerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SimpleMove", new LuaCSFunction(SimpleMove));
		L.RegFunction("Move", new LuaCSFunction(Move));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_CharacterController));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("velocity", new LuaCSFunction(get_velocity), null);
		L.RegVar("isGrounded", new LuaCSFunction(get_isGrounded), null);
		L.RegVar("collisionFlags", new LuaCSFunction(get_collisionFlags), null);
		...
		L.RegVar("slopeLimit", new LuaCSFunction(get_slopeLimit), new LuaCSFunction(set_slopeLimit));
		L.RegVar("stepOffset", new LuaCSFunction(get_stepOffset), new LuaCSFunction(set_stepOffset));
		L.RegVar("skinWidth", new LuaCSFunction(get_skinWidth), new LuaCSFunction(set_skinWidth));
		L.RegVar("minMoveDistance", new LuaCSFunction(get_minMoveDistance), new LuaCSFunction(set_minMoveDistance));
		L.RegVar("detectCollisions", new LuaCSFunction(get_detectCollisions), new LuaCSFunction(set_detectCollisions));
		L.RegVar("enableOverlapRecovery", new LuaCSFunction(get_enableOverlapRecovery), new LuaCSFunction(set_enableOverlapRecovery));
		L.EndClass();
	}
