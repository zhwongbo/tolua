...
public class UnityEngine_MeshColliderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_MeshCollider));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("sharedMesh", new LuaCSFunction(get_sharedMesh), new LuaCSFunction(set_sharedMesh));
		L.RegVar("convex", new LuaCSFunction(get_convex), new LuaCSFunction(set_convex));
		L.RegVar("cookingOptions", new LuaCSFunction(get_cookingOptions), new LuaCSFunction(set_cookingOptions));
		L.EndClass();
	}
	...
	static int set_cookingOptions(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.MeshCollider obj = (UnityEngine.MeshCollider)o;
			UnityEngine.MeshColliderCookingOptions arg0 = (UnityEngine.MeshColliderCookingOptions)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.MeshColliderCookingOptions>.type);
