...
public class UnityEngine_InputWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetPenEvent", new LuaCSFunction(GetPenEvent));
		L.RegFunction("GetLastPenContactEvent", new LuaCSFunction(GetLastPenContactEvent));
		L.RegFunction("ResetPenEvents", new LuaCSFunction(ResetPenEvents));
		L.RegFunction("ClearLastPenContactEvent", new LuaCSFunction(ClearLastPenContactEvent));
		...
		L.RegVar("penEventCount", new LuaCSFunction(get_penEventCount), null);
