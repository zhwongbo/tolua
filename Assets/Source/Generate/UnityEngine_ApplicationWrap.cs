...
public class UnityEngine_ApplicationWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("exitCancellationToken", new LuaCSFunction(get_exitCancellationToken), null);
		...
		L.RegVar("memoryUsageChanged", new LuaCSFunction(get_memoryUsageChanged), new LuaCSFunction(set_memoryUsageChanged));
