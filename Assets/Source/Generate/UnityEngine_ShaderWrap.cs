...
public class UnityEngine_ShaderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetPropertyDefaultIntValue", new LuaCSFunction(GetPropertyDefaultIntValue));
		...
		L.RegVar("maximumChunksOverride", new LuaCSFunction(get_maximumChunksOverride), new LuaCSFunction(set_maximumChunksOverride));
