...
public class UnityEngine_MaterialWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("CopyMatchingPropertiesFromMaterial", new LuaCSFunction(CopyMatchingPropertiesFromMaterial));
		...
		L.RegFunction("GetConstantBuffer", new LuaCSFunction(GetConstantBuffer));
		...
		L.RegFunction("GetPropertyNames", new LuaCSFunction(GetPropertyNames));
		...
		L.RegVar("enabledKeywords", new LuaCSFunction(get_enabledKeywords), new LuaCSFunction(set_enabledKeywords));
	...
	static int GetPropertyNames(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Material obj = (UnityEngine.Material)ToLua.CheckObject<UnityEngine.Material>(L, 1);
			UnityEngine.MaterialPropertyType arg0 = (UnityEngine.MaterialPropertyType)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.MaterialPropertyType>.type);
