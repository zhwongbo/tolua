...
public class UnityEngine_SkinWeightsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("OneBone", new LuaCSFunction(get_OneBone), null);
		L.RegVar("TwoBones", new LuaCSFunction(get_TwoBones), null);
		L.RegVar("FourBones", new LuaCSFunction(get_FourBones), null);
		L.RegVar("Unlimited", new LuaCSFunction(get_Unlimited), null);
	...
	static Type TypeOf_UnityEngine_SkinWeights = typeof(UnityEngine.SkinWeights);

	static bool CheckType(IntPtr L, int pos)
	{
		return TypeChecker.CheckEnumType(TypeOf_UnityEngine_SkinWeights, L, pos);
	}
